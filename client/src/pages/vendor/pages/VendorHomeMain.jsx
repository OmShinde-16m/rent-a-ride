...
const VendorHomeMain = () => {
  ...
  const statCards = [
    ...
    { title: "Active Bookings", key: "activeBookings", color: "rgb(0, 227, 150)", bg: "rgba(0, 227, 150, 0.2)" },
    { title: "My Earnings", key: "totalEarnings", color: "rgb(251, 146, 60)", bg: "rgba(251, 146, 60, 0.2)" },
  ];
    ...
    <div className="mt-12 ">
        ...
        <div className=" dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 xl:w-full 2xl:w-80 p-8 pt-9 m-3  bg-hero-pattern bg-no-repeat bg-cover   bg-slate-50 xl:h-[250px] 2xl:h-44">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl text-black">{username || "Vendor"}</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex gap-10 m-4 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl">
          <p className="text-xl font-semibold">My Recent Bookings</p>
        </div>
