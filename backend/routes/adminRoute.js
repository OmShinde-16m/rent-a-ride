...
import { adminAuth ,adminProfiile, getDashboardStats } from "../controllers/adminControllers/adminController.js"
...
router.get('/dashboardStats',verifyToken,getDashboardStats)
